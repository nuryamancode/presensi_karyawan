@extends('karyawan.layout.v-home', ['title' => 'Presensi Pulang'])
        ...
        <div class="section full mt-2">
            <div class="wide-block pt-2 pb-2">
                ...
                <div class="row">
                    ...
                    <form action="{{ route('employee.post.presensi.pulang.with.alasan') }}" method="post">
                        @csrf
                        <div class="col">
                            <h2 class="mt-2">
                            ...
                            <input type="hidden" class="form-control" value="{{ $alasan->id }}" name="alasan">
