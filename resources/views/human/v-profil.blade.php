@extends('layout.v-home', ['title' => 'Profil - HR'])
...
@section('content')
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <div class="mb-4">
                    <a href="{{ route('hr.dashboard') }}" style="text-decoration: none; color: #000;">
                ...
                <form action="{{ route('hr.edit.profil') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-2">
                            @if ($hr->foto_diri == null)
                                <img src="{{ asset('image/avatar-2.jpg') }}" class="border rounded border-dark p-2"
                                    alt="Profil Picture" width="200" id="previewImage">
                            @else
                                <img src="{{ asset($hr->foto_diri) }}" class="border rounded border-dark p-3"
                                    alt="Profil Picture" width="200" id="previewImage">
                            @endif
                        ...
                        <div class="col-2">
                            <div class="mb-3">
                                ...
                                <h6 class="fw-bold mt-3">{{ $hr->user->email }}</h6>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Jabatan</label>
                                <h6 class="fw-bold mt-3">{{ $hr->user->level }}</h6>
                            </div>
                        </div>
                        <div class="col-8">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nomor_wa" class="form-control rounded border-dark"
                                            value="{{ $hr->nomor_wa ?? '' }}" pattern="[0-9]+" title="Masukkan hanya nomor">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control rounded border-dark" placeholder="Leave a comment here" name="alamat"
                                            id="floatingTextarea2" style="height: 100px">{{ $hr->alamat_lengkap ?? '' }}</textarea>
