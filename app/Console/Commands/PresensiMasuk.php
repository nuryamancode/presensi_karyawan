...
class PresensiMasuk extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'presensi:masuk';
    ...
    public function handle()
    {
        ...
        $message = "Selamat Pagi *{nama_lengkap}*,\nJangan lupa untuk melakukan presensi masuk pada pukul *09:00* di aplikasi tautan tersebut.\n\nhttps://marecayasa.com/\n\n\nSalam Hormat: Direktur,\nSulaiman A.md";
